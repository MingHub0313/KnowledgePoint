...
public class BaseDataTest {
    ...
    public void questionOne() {
        ...
        log.info("转出的结果 {}", i);
        /**
         * 答案 : 可以转 但是需要异常处理 ---> NumberFormatException  ---》RuntimeException
         * 1).当要转的是 字母 内容不是数字时  	如 : String s = "mmm";
         * 2).当要转的是 null 					如 : String s = null;
         * 3).当要转的超过 int 上限(下限)时		如 : String s = "12326544451545"; 2^31 = 2147483648  21亿
         */
    }
     ...
     *  		如果左边的变量精度低于右边的结果的精度 编译器会显式的报错.  ==>【比较精度得结果】
